...
local M,pool={},{}
local color={0xffa000,0xff4000,0x60c0ff,0x08d020,0xe050d8,hit=0xffffff,fire=0xff1800,water=0x0030ff,grass=0x08d020,elec=0xffa000,psy=0xe050d8,burn=0xff0800,seed=0x08c018,par=0xffa000,def=0x1060ff,win=0x00ff30,lose=0xff0000,appear=0xffffff}
